...
declare module 'rclnodejs' {
  ...
  namespace motion_msgs {
    namespace msg {
      export interface LegMotors {
        header: std_msgs.msg.Header;
        left_hip_enc_rev: number;
        left_hip_pos: number;
        left_hip_vel: number;
        left_hip_iq: number;
        left_knee_enc_rev: number;
        left_knee_pos: number;
        left_knee_vel: number;
        left_knee_iq: number;
        left_wheel_enc_rev: number;
        left_wheel_pos: number;
        left_wheel_vel: number;
        left_wheel_iq: number;
        right_hip_enc_rev: number;
        right_hip_pos: number;
        right_hip_vel: number;
        right_hip_iq: number;
        right_knee_enc_rev: number;
        right_knee_pos: number;
        right_knee_vel: number;
        right_knee_iq: number;
        right_wheel_enc_rev: number;
        right_wheel_pos: number;
        right_wheel_vel: number;
        right_wheel_iq: number;
        left_leg_length: number;
        right_leg_length: number;
      }
      export interface LegMotorsConstructor {
        new(other?: LegMotors): LegMotors;
      }
      export interface MotionCtrl {
        cmd_id: number;
        value: number;
      }
      export interface MotionCtrlConstructor {
        new(other?: MotionCtrl): MotionCtrl;
      }
      export interface RobotStatus {
        header: std_msgs.msg.Header;
        ctrl_mode_msg: number;
        robot_mode_msg: number;
        error_msg: number;
        warning_msg: number;
      }
  ...
  type MessagesMap = {
    ...
    'motion_msgs/msg/LegMotors': motion_msgs.msg.LegMotors,
    'motion_msgs/msg/MotionCtrl': motion_msgs.msg.MotionCtrl,
    'motion_msgs/msg/RobotStatus': motion_msgs.msg.RobotStatus,
  ...
  type MessageTypeClassConstructorMap = {
    ...
    'motion_msgs/msg/LegMotors': motion_msgs.msg.LegMotorsConstructor,
    'motion_msgs/msg/MotionCtrl': motion_msgs.msg.MotionCtrlConstructor,
    'motion_msgs/msg/RobotStatus': motion_msgs.msg.RobotStatusConstructor,
